...
public class EquipmentModel implements Serializable {
    ...
    @SerializedName("STOCK_ROLLS")
    @Expose
    private String STOCK_ROLLS;

    public String getSTOCK_ROLLS() {
        return STOCK_ROLLS;
    }

    public void setSTOCK_ROLLS(String STOCK_ROLLS) {
        this.STOCK_ROLLS = STOCK_ROLLS;
    }
